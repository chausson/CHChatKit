...
- (void)setPlaceHolder:(NSString *)placeHolder {
    ...
    NSUInteger maxChars = [CHChatTextView maxCharactersPerLine];
...
{
    return [CHChatTextView numberOfLinesForMessage:self.text];
}
...
+ (NSUInteger)numberOfLinesForMessage:(NSString *)text {
    return (text.length / [CHChatTextView maxCharactersPerLine]) + 1;
}
